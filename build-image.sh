...
# 2) Dockefile folder, Docker image name, and Dockerhub repository have the same name. This will enable you to build ...
# ...push to Docker registory without tagging it to a new image before pushing.
# 4) This setup can help you build different docker images with the same buildspec.yml file and push to DHR...
